...
from refining.column_names import PRODUCT_COL, DELIVERY_START_COL, DELIVERY_END_COL, DELIVERY_AREA_COL, VOLUME_COL

HIGHEST_VOLUME_FINANCIAL_PRODUCT_SCHEMA = StructType([
